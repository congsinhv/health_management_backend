...
async def test_create_or_update_schedule_fixed(service):
    ...
    with patch("app.services.schedule.service.generate_weekly_plan", new_callable=AsyncMock) as mock_gen, \
         patch("app.services.schedule.service.schedule_notifications_for_week") as mock_sched:
