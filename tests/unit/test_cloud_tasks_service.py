...
class TestCloudTasksService:
    ...
    def mock_settings(self):
        ...
        with patch("app.services.cloud_tasks.settings") as mock:
            ...
            mock.cloud_tasks_service_account = "test-sa@test-project.iam.gserviceaccount.com"
    ...
    def test_initialization(self, mock_settings):
        ...
        assert service.parent == "projects/test-project/locations/asia-southeast1/queues/test-queue"
    ...
    async def test_create_notification_task_success(self, cloud_tasks_service):
        ...
        with patch.object(
            ...
            with patch.object(
                tasks_v2, "CloudTasksClient", return_value=mock_client
            ):
    ...
    async def test_create_notification_task_already_exists(self, cloud_tasks_service):
        ...
        with patch.object(
            ...
            mock_client = MagicMock()
            mock_client.create_task.side_effect = Exception("ALREADY_EXISTS: Task already exists")
...
class TestCloudTasksConfig:
    ...
    def test_config_from_env(self):
        ...
        assert settings.cloud_tasks_service_account == "test-sa@project.iam.gserviceaccount.com"
